...
class DynamicLightningModelForTrain(pl.LightningModule):
    ...
    def on_save_checkpoint(self, checkpoint):
        checkpoint_dir = "/home/zhuyixuan05/ReCamMaster/sekai_dynamic_2"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_path", type=str, default="/share_zhuyixuan05/zhuyixuan05/sekai-game-drone")
