...
class DynamicRLBenchDataset(torch.utils.data.Dataset):
    ...
    def create_pose_embeddings(self, cam_data, segment_info):
        ...
        for idx in keyframe_original_idx:
            ...
            # assert False
            relative_cams.append(torch.as_tensor(cam_prev))
...
class DynamicLightningModelForTrain(pl.LightningModule):
    def __init__(
        ...
        for block in self.pipe.dit.blocks:
            block.cam_encoder = nn.Linear(30 , dim)
    ...
    def on_save_checkpoint(self, checkpoint):
        checkpoint_dir = "/home/zhuyixuan05/ReCamMaster/RLBench-train"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset_path", type=str, default="/share_zhuyixuan05/zhuyixuan05/rlbench")
